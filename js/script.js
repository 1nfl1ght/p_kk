window.onload = function() {
    ...
    panInput.addEventListener("input", () => {
        panInput.style.border = "1px solid #0086FF";
        panInput.style.boxShadow = "none";
    })

    panInput.addEventListener("focus", () => {
        panInput.style.border = "1px solid #CCCCCC";
        panInput.style.boxShadow = "0 0 0 4px #8FCDEF";
    })
    ...
    cvvInput.addEventListener("input", () => {
        cvvInput.style.border = "1px solid #0086FF";
        cvvInput.style.boxShadow = "none";
    })

    cvvInput.addEventListener("focus", () => {
        cvvInput.style.border = "1px solid #CCCCCC";
        cvvInput.style.boxShadow = "0 0 0 4px #8FCDEF";
    })
...
function checkErrors() {
    ...
    let inputs = [ panInput, expDateBlock, cvvInput ];
